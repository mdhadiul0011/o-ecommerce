                ...
                <div  className='sm:w-[18%] w-[25%] relative'>
                    ...
                    user && 
                        <div className='z-50 w-[190px] bg-black shodow-md  absolute top-12 right-0' ref={userRef}>
                            ...
                            {
                                UserData.map((item, i)=> (
                                    <ListItems key={i} links={item.link}  className='font-primaryFont last:border-b-0 font-normal text-sm text-gray hover:text-white hover:font-bold py-4 px-2 border-b border-solid hover:pl-3 transition-all duration-150 ease-in border-gray'>{item.title}</ListItems>
                                ))
                            }
                            </List>
                        </div>
